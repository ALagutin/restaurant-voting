...
VALUES ('Брауни', 1000, 1, '2022-05-12'),
       ('Сырники из творога', 1000, 1, '2022-05-12'),
       ('Спагетти карбонара с красным луком', 2000, 2, '2022-05-12'),
       ('Классическая шарлотка', 2000, 2, '2022-05-12'),
       ('Американский тыквенный пирог с корицей', 1000, 1, '2022-05-13'),
       ('Азу по-татарски', 1000, 1, '2022-05-13'),
       ('Лазанья классическая с мясом', 3000, 3, '2022-05-13'),
       ('Тонкие блины на молоке', 3000, 3, '2022-05-13');
